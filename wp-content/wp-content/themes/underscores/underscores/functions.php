<?php
// update_option( 'siteurl', 'http://cglaw-firm.com' );
// update_option( 'home', 'http://cglaw-firm.com' );
/**
...
function underscores_scripts() {
	// The default style that entered in with this awful theme
...
//Create a callback function to enqueue stylesheets
function new_style() {
	 ...
	 //Create a sort of event listener to trigger the callback enqueue scrips are invoked.
