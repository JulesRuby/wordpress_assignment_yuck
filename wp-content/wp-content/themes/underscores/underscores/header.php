...
<!-- Pay attention to this head function, it help with enqueuing -->
	<?php wp_head(); ?>
</head>
...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		...
		if ( is_front_page() ) :
				...
				<img src="<?php get_template_directory_uri();?>wp-content/uploads/2020/03/cglaw-header-1536x1024.jpg" alt="">
			</div>
			<?php endif ?>
	</header><!-- #masthead -->
